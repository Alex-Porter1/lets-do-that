...
from .views import api_list_activities, api_list_categories, api_list_ratings, api_show_activities, api_show_categories, api_show_ratings
...
urlpatterns = [
    ...
    path("ratings/<int:pk>/", api_show_ratings, name="api_show_ratings"),
